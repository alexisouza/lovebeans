...
public class LoveCustomizerProvider implements CustomizerProvider {
    
    public final LoveProject project;
    
    public static final String CUSTOMIZER_FOLDER_PATH = "Projects/org-lovebeans-project/Customizer";
    
    public LoveCustomizerProvider(LoveProject project) {
